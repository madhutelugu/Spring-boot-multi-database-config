...
@EnableJpaRepositories(
		...
		basePackages = "com.devglan.audit.dao"
)
public class AuditDBConfig {
	...
	public PlatformTransactionManager mysqlTransactionManager(@Qualifier("auditEntityManager") EntityManagerFactory entityManagerFactory) {
